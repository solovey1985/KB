...
- [What's new in C# 11](#whats-new-in-c-11)
  ...
  - [Pattern match `Span<char>` or `ReadOnlySpan<char>` on a constant `string`](#pattern-match-spanchar-or-readonlyspanchar-on-a-constant-string)
  - [Extended nameof scope](#extended-nameof-scope)
  - [UTF-8 string literals](#utf-8-string-literals)
  - [Required members](#required-members)
  - [`ref` fields and `ref scoped` variables](#ref-fields-and-ref-scoped-variables)
